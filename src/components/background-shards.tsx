...
export default function BackgroundShards() {
  return (
    <div className="fixed inset-0 -z-20 overflow-hidden bg-background">
      {/* Shards for Light Theme: soft blue and light gray shards */}
      <div className="block dark:hidden">
        <Shard className="top-[-20%] left-[-15%] w-1/2 h-1/2 transform rotate-12" colorClass="text-primary/5" />
        <Shard className="top-[-10%] right-[-15%] w-1/3 h-1/3 transform -rotate-24" colorClass="text-primary/10" />
        ...
        <Shard className="top-[50%] right-[5%] w-1/3 h-1/3 transform rotate-20" colorClass="text-primary/10" />
        <Shard className="top-[70%] left-[20%] w-1/6 h-1/6 transform rotate-50" colorClass="text-muted" />
        <Shard className="bottom-[-20%] left-[5%] w-1/2 h-1/2 transform rotate-45" colorClass="text-primary/10" />
        ...
        <Shard className="bottom-[15%] right-[-10%] w-2/5 h-2/5 transform -rotate-30" colorClass="text-muted" />
        <Shard className="top-[80%] left-[-10%] w-1/3 h-1/3 transform rotate-60" colorClass="text-primary/5" />
      </div>

      {/* Shards for Dark Theme: translucent white shards */}
